...
This is the repository for my kubernetes homelab running on bare metal (in my house). It contains six physical nodes: three desktops and three laptops, with manufacturing years ranging from 2011 - 2017.
...
Individual documentation is available for each step of the build process:

- [Cluster Initialization](./docs/build.md#cluster-initialization)
